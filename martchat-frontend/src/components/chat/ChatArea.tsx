...
export default function ChatArea() {
  ...
  const { currentRoomId, rooms, messages, typingUsers, addMessage } =
    useChatStore();
  ...
  useEffect(() => {
    ...
    function joinRoom() {
      conn.invoke("EntrarNoChatRoom", currentRoomId).catch(console.error);
    }
    ...
    return () => {
      conn.invoke("SairDoChatRoom", currentRoomId).catch(() => {});
    };
  }, [currentRoomId]);
  ...
  useEffect(() => {
    ...
    async function loadMessages() {
      try {
        ...
        const { data } = await api.get(`/api/rooms/${currentRoomId}/messages`);
    ...
    return (
      <div className={styles.empty}>
        <div className={styles.emptyContent}>
          ...
          <p>
            Escolha uma sala de inspeção na sidebar para começar a monitorar
          </p>
